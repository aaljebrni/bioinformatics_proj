...
the E-TABM-185-sdrf1.csv file is only used when u wanna created new dataset using the code in bioinformatics_project_dataset_creation.py of course u will ave to use the microarray file as well, I didn't attach it here because of its massive size, and then use the DAE to reduce the dimensionality of the generated dataset

Or, in case you did not find any attached csv files except the 'E-TABM-185-sdrf1.csv' you can run the files in the following order (assuming you have the microarray file)
